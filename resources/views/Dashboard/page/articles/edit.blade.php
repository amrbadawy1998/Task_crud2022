        ...
        <div class="container-fluid">
            <div class="col-md-12">
                ...
                <div class="card card-outline card-primary">
                    <!-- /.card-header -->
                    <div class="card-body ">
                        <form method="post" class=" needs-validation"  action="{{route("article.update")}}" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-md-12 ">
                                    <label for="validationCustom01" class="form-label"> العنوان </label>
                                    <input type="text" class="form-control text-center" value="{{$article->title}}" autocomplete="off" id="validationCustom01" name="title" required>
                            ...
                            <div class="row">
                             ...
                             <textarea name="body"  class="textarea" placeholder="Place some text here"
                                       style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" > {!! $article->body !!}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" class="form-control">
                                            ...
                                            @foreach($categories as $cat)
                                                <option value="{{$cat->id}}" <?php if($cat->id == $article->category_id ){echo "selected";}?> > {{$cat->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
