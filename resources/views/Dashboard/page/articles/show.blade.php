...
@section("path","المقالات")
@section("content_title"," إستعراض  ")
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped table-hover">
                                        ...
                                        @foreach($article as $da)
                                            <tr>
                                                <th>{{$da->title }}</th>
                                                <th><img src="{{$da->image_path}}"></th>
                                                <th>
                                                    <div class="btn-group btn-group-sm">
                                                        <form method="post" action="{{route("article.delete",$da->id)}}">
                                                            @csrf
                                                            <button type="submit" class="btn btn-danger btn-sm  m-1" ><i class="fas fa-trash"></i></button>
                                                        </form>
                                                        <form method="get" action="{{route("article.edit",$da->id)}}">
                                                            @csrf
                                                        <button    class="btn btn-info btn-sm m-1"><i class="fas fa-eye"></i></button>
                                                        </form>
                                                    </div>
                                                </th>
                                            </tr>
