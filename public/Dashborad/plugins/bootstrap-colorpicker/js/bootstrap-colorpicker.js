...
var ColorItem = function () {
  _createClass(ColorItem, [{
     ...
     * @param {String|null} format Color Models to convert to by default. Supported: 'rgb', 'hsl', 'hex'.
...
function Color(obj, model) {
	...
	if (model && !(model in convert)) {
		throw new Error('Unknown Models: ' + model);
	}
...
// Models conversion methods and static constructors
Object.keys(convert).forEach(function (model) {
